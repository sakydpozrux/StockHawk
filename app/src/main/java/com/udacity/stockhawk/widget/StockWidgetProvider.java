...
public class StockWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId: appWidgetIds) {
            ...
            views.setOnClickPendingIntent(R.id.stocks_bar, pendingIntent);

            views.setRemoteAdapter(R.id.stocks_list, new Intent(context, StockWidgetService.class));
            views.setEmptyView(R.id.stocks_list, R.id.text_error_empty);
